    ...
    <div className="min-h-screen bg-black p-16">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col gap-32">
          ...
          <div className="flex gap-12 items-center w-full max-w-3xl ml-auto mr-16">
            <img
              src="/services1.jpg"
              alt="Mixing Console"
              className="w-56 h-56 object-cover rounded-lg flex-shrink-0"
            />
            <div className="flex flex-col gap-6 flex-1">
              ...
              <button className="bg-[#3b96a2] text-white px-12 py-3 rounded-full text-lg font-medium hover:bg-[#2d7782] transition-colors shadow-lg w-fit">
                Contact us
              </button>
            </div>
          </div>
